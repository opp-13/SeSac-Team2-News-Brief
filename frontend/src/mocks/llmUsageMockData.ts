...
export const mockDailyUsage: DailyUsage[] = [
  { date: '08/13', openai: 1.24, anthropic: 2.18, google: 0.43, tokens: 4_820_000 },
  { date: '08/14', openai: 1.31, anthropic: 2.05, google: 0.38, tokens: 5_140_000 },
  { date: '08/15', openai: 0.98, anthropic: 1.87, google: 0.51, tokens: 4_390_000 },
  { date: '08/16', openai: 1.45, anthropic: 2.34, google: 0.29, tokens: 5_680_000 },
  { date: '08/17', openai: 1.22, anthropic: 2.11, google: 0.44, tokens: 4_910_000 },
  { date: '08/18', openai: 1.38, anthropic: 2.29, google: 0.36, tokens: 5_320_000 },
  { date: '08/19', openai: 0.72, anthropic: 1.14, google: 0.18, tokens: 2_740_000 },
]
...
export const mockModelDistribution: ModelUsage[] = [
  { model: 'claude-sonnet-5', provider: 'anthropic', calls: 9840, pct: 54 },
  { model: 'gpt-4o', provider: 'openai', calls: 6230, pct: 34 },
  { model: 'gemini-2.0-flash', provider: 'google', calls: 2224, pct: 12 },
]
